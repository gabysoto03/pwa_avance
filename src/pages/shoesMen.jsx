...
function ShoesMen() {
    ...
    const listenShoes = (pagina) => {
        const shoesRef = collection(db, "zapatos", "menShoes", pagina);
    ...
    return (
        <div className="min-h-screen w-full p-6">
            ...
            <p className="flex items-center justify-center text-[40px] mb-10 mt-2 font-semibold">{pagina} para hombre</p>
