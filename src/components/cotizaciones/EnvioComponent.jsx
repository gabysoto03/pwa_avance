                ...
                <div className="w-[80%] h-[50%] flex">
                    <div className="w-[20%] h-full">
                        <section className="flex w-[50%] mb-10">
                            ...
                            <p className="text-text font-bold text-[20px]">Dirección</p>
                        </section>
                        <section className="flex w-[50%]">
                            ...
                            <p className="text-text font-bold text-[20px]">Paquetería</p>
                        </section>
                    </div>
                    <div className="w-[80%] h-full">
                        <input className="w-full h-[20%] rounded-full bg-inputs text-text outline-none px-5" value={envioOption} type="text" readOnly />
                    </div>
                </div>

                <div className="w-[80%] h-[30%] flex items-center">
                    <p className="text-text text-[22px] font-bold mr-4" >Tiempo de entrega</p>
                    <input 
                        type="number" 
                        className="w-[10%] h-[50%] rounded-xl outline-none text-center text-text text-[20px] font-semibold" 
                        min="1" 
                        name="" 
                        id="" 
                    ...
                    />
                    <p className="text-text text-[16px] font-bold ml-4" >Semanas</p>
                </div>

                <p className="w-full px-16 text-xs text-text">Si coloca un valor de cero o negativo será por defecto 1 semana.</p>
